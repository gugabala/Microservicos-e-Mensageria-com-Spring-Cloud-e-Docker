...
import br.net.garcez.mscartoes.application.representation.CartaoSaveRequest;
import br.net.garcez.mscartoes.application.representation.CartoesPorClienteResponse;
